...
line([B(1),Xoptimal(nbpoints,1)],[B(2),Xoptimal(nbpoints,2)],'Color','green','LineWidth',2);

colorarray = ["yellow","green","yellow","green","yellow","green","yellow","green"];

for iter = 1:(nbpoints-1)
    line([Xoptimal(iter,1),Xoptimal(iter+1,1)],[Xoptimal(iter,2),Xoptimal(iter+1,2)],'Color',colorarray(iter),'LineWidth',2);
end
